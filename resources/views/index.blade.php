      ...
      <div class="col-sm-12 col-md-6 col-lg-6 pic-left">
        <div class="swiper-container bannerbox">
          <div class="swiper-wrapper">
            <div class="swiper-slide banlist"> <img src="./upload/images/2017/6/29913228.png" onClick="window.location.href='./contents/139/923.html'"
                alt="与《冈仁波齐》一起艰难修行：导演张杨背后的三个商人" />
            </div>

            <div class="swiper-slide banlist"> <img src="./upload/images/2017/6/2992257394.png" onClick="window.location.href='./contents/139/922.html'"
                alt="手术方案可以用AI全程设计了，科幻离现实还有多远？" /> </div>

            <div class="swiper-slide banlist"> <img src="./upload/images/2017/6/29929562.png" onClick="window.location.href='./contents/139/921.html'"
                alt="孔令辉刘国梁相继被“废”，苟局长对国乒动刀到底想干啥？" /> </div>
          </div>
      ...
      <div class="col-sm-12 col-md-8 col-lg-8 cont-left">
        <div id="hour24" class="clearfix">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 hour24-left">
            ...
            <div class="hour24-left-img"> <a href="./images/timthumb (5).jpg" title="水性PK&#65281;三星S8 vs iPhone 7，究竟谁才是水下高手？"
                target="_blank"> <img src="./images/timthumb (5).jpg" alt="水性PK&#65281;三星S8 vs iPhone 7，究竟谁才是水下高手？" />
              </a> </div>
            ...
            <div class="mob-sub"> {{mb_substr($prod->detail, 0, 10)}}</div>
          ...
          <div class="la-r-text">
            ...
            <div class="mob-author">
              <span class="time">
                ...
                <a href="./contents/141/965.html" style="color: #bbb;">国际视野</a>
              </span>
              <span class="time">
            ...
            <div class="tags">
              ...
              <a href="./utils/tags.html?tagName=无人驾驶" rel="tag">无人驾驶</a>

              <a href="./utils/tags.html?tagName=汽车" rel="tag">汽车</a>
        ...
        <div id="page">
          {{$news->links()}}
          <!-- <a href="./index.html" style="background:#3CA5F6;">上一页</a>
              <a href="./index.html">1</a>
            <span id="page-numberscurrent">2</span> 
              <a href="./index_3.html">3</a>
              <a href="./index_4.html">4</a>
              <a href="./index_3.html" style="background:#3CA5F6;">下一页</a> -->
        </div>
        ...
        <div class="widget widget_ztmao_hotpost2">
          ...
          <div class="box-moder hot-article"> <span class="span-mark"></span>
            <ul class="hots-post-widget">
              <li>
                <div class="mod-thumb"> <a href="./contents/131/931.html" target="_blank"> <img class="xyscale" src="./images/timthumb (5).jpg"
                      alt="人工智能创业到底能不能挣钱，可盈利的机会又在哪儿？" /> </a> </div>
                <div class="project-content"> <a href="./contents/131/931.html" target="_blank">人工智能创业到底能不能挣钱，可盈利的机会又在哪儿？</a>
                </div>
              </li>
        ...
        <div class="widget widget_ztmao_mostviews">
          ...
          <div class="box-moder hot-article"> <span class="span-mark"></span>
            <ul class="hots-post-widget">
              ...
              <li>
                <div class="hot-article-img"> <a href="./contents/131/925.html" target="_blank"> <img class="xyscale"
                      src="./upload/images/2017/6/2985515978.jpg" alt="{{$hot->title}}" /> </a> </div>
