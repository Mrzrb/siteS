        ...
        <div class="swiper-container bannerbox">
          <div class="swiper-wrapper">
            <div class="swiper-slide banlist"> <img src="./upload/images/2017/6/29913228.png" onClick="window.location.href='./contents/139/923.html'"
                alt="与《冈仁波齐》一起艰难修行：导演张杨背后的三个商人" /> </div>
        ...
        <div class="widget widget_ztmao_mostviews">
          ...
          <div class="box-moder hot-article"> <span class="span-mark"></span>
            <ul class="hots-post-widget">
              ...
              <li>
                <div class="hot-article-img"> <a href="{{$hot->getUrl()}}" target="_blank"> <img class="xyscale" src="{{$hot->img_url}}"
                      alt="{{$hot->title}}" /> </a> </div>
                <a href="{{$hot->getUrl()}}" class="transition" target="_blank">{{$hot->title}}</a>
              </li>
              @endforeach
        ...
        <div class="box-moder hot-tag ztmao-lianjie">
          ...
          <div class="search-history search-hot">
            <ul>
              ...
              <li><a href="{{$link->url}}">{{$link->fkey}}</a></li>
              @endforeach
              @endif
            </ul>
          </div>
